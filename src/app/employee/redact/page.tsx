  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <span className="text-xs font-mono font-bold text-seal-400 uppercase tracking-wider">Privacy Engine</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="p-4 rounded-xl bg-ink-900/80 border border-ink-800 flex items-start gap-3">
          <ShieldAlert className="w-5 h-5 text-red-400 shrink-0 mt-0.5" />
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-white">The Pregnancy Bias Hazard</h4>
        ...
        <div className="p-4 rounded-xl bg-ink-900/80 border border-ink-800 flex items-start gap-3">
          ...
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-white">Mental Health & Stigma</h4>
            <p className="text-[11px] text-slate-400 leading-relaxed">
        ...
        <div className="p-4 rounded-xl bg-ink-900/80 border border-ink-800 flex items-start gap-3">
          <FileCheck2 className="w-5 h-5 text-seal-400 shrink-0 mt-0.5" />
          <div className="space-y-1">
            <h4 className="text-xs font-bold text-white">The Vouch Standard</h4>
            <p className="text-[11px] text-slate-400 leading-relaxed">
