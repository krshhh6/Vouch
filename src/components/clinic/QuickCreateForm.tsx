...
export default function QuickCreateForm({ clinicProfile, onCreated }: QuickCreateFormProps) {
  ...
  return (
    <div className="bg-[#111C2E] border border-slate-800 rounded-xl p-6 shadow-xl space-y-6">
      {/* Header */}
      <div className="border-b border-slate-800/80 pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-400"></span>
            <h2 className="text-lg font-bold text-white font-condensed uppercase tracking-wider">
              Create Leave Proof
            </h2>
          </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <label
                  ...
                  className={`flex items-start gap-3 p-3 rounded-lg border cursor-pointer transition text-left ${
                    isSelected
                      ...
                      : 'bg-[#0A1220] border-slate-800 text-slate-300 hover:border-slate-700 hover:bg-[#0D172A]'
                  }`}
                >
                  <input
                    type="radio"
                    ...
                    className="mt-1 text-emerald-600 focus:ring-emerald-500 h-3.5 w-3.5 border-slate-700"
                  />
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2 bg-[#090F1B] border border-slate-700 rounded-md text-xs text-slate-100 focus:outline-none focus:border-emerald-500 font-mono"
                />
              </div>
            </div>
              ...
              return (
                ...
                >
                  <input
                    ...
                    className="text-emerald-600 focus:ring-emerald-500 h-3.5 w-3.5 border-slate-700"
                  />
        ...
        <button
          ...
          className="w-full py-3.5 px-4 bg-emerald-600 hover:bg-emerald-500 disabled:bg-slate-700 text-white rounded-lg text-xs font-bold uppercase tracking-wider transition shadow-lg flex items-center justify-center gap-2 font-mono"
        >
          {isSubmitting ? (
            <>
