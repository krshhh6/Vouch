  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        heading: ['var(--font-plus-jakarta)', '"Plus Jakarta Sans"', 'var(--font-inter)', 'Inter', 'sans-serif'],
        display: ['var(--font-plus-jakarta)', '"Plus Jakarta Sans"', 'var(--font-inter)', 'Inter', 'sans-serif'],
        ...
        bowlby: ['var(--font-plus-jakarta)', '"Plus Jakarta Sans"', 'sans-serif'],
        oswald: ['var(--font-inter)', 'Inter', 'sans-serif'],
        condensed: ['var(--font-inter)', 'Inter', 'sans-serif'],
